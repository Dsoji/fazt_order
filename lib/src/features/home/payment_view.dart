...
class PaymentScreen extends StatefulWidget {
  ...
  const PaymentScreen({
    ...
    required this.total, required this.orderItems,
  }) : super(key: key);
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      Text("Subtotal (3 items)", style: ktBodyRegularSize14.copyWith(color: kcPrimaryNeutral300)),
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Text("₦${widget.taxAndFees.toStringAsFixed(0)}",
                        style: ktBodyRegularSize14.copyWith(color: kcPrimaryNeutral100, fontWeight: FontWeight.w400),
                      ),
                    ],
                  ),
            ...
            Text(
              "Payment Method",
              style: ktBodyRegularSize16.copyWith(color: kcPrimaryNeutral100, fontWeight: FontWeight.w400),
            ),
            ...
            // Wallet Option
            ListTile(
              leading: const Icon(Iconsax.wallet_1, color: kcPrimaryNeutral200, size: 20,),
              title: Text("₦1,000,000", style: ktBodyRegularSize18.copyWith(color: kcPrimaryNeutral100, fontWeight: FontWeight.w400),
              ),
              subtitle: Text("Wallet", style: ktBodyRegularSize14.copyWith(color: kcPrimaryNeutral300, fontWeight: FontWeight.w400),
              ),
              trailing: _selectedPaymentMethod == "Wallet"
                  ? const Icon(Iconsax.tick_circle5, size: 20, color: kcPrimaryGreen400)
                  : const Icon(Iconsax.tick_circle, size: 20, color: kcPrimaryNeutral200),
              onTap: () {
                setState(() {
            ...
            ListTile(
              leading: const Icon(Iconsax.cards, color: kcPrimaryNeutral300, size: 20,),
              title: Text("Credit/Debit Cards", style: ktBodyRegularSize16.copyWith(color: kcPrimaryNeutral100, fontWeight: FontWeight.w400),),
              onTap: () {
                setState(() {
              ...
              Padding(
                ...
                child: Text(
                  "Choose the card to pay with",
                    style: ktBodyRegularSize12.copyWith(color: kcPrimaryNeutral300, fontWeight: FontWeight.w400),
                ),
              ),
              ListTile(
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                onPressed: (_selectedPaymentMethod == "Wallet" || _selectedCard != null)
                    ? () {
