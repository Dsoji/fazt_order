...
class Meal {
  ...
  @override
  String toString() {
    return 'Meal(id: $id, mealName: $mealName, mealDescription: $mealDescription, mealImage: $mealImage, price: $price, priceDescription: $priceDescription, category: $category, store: $store)';
  }
